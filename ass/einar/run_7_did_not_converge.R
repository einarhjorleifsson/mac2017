...
# Added
conf$keyVarObs[1,] <- c(0, 1, 2, 3,4,4,4,4,4,3,2,1,0)
conf$keyVarObs[2,1] <- 5
conf$keyVarObs[3,1] <- 6
conf$keyVarObs[4,]  <- c(-1,-1,-1, 7,8,8,8,8,8,8,8,7,-1)
...
# NOT TESTED: could not do 4 years of retro
ret <- NULL
save(fit, ret, file="fit_run7.rda")
